export default function BoostSection() {
  return (
    <section
      className={"bg-darkPurple flex flex-col items-center gap-y-4 bg-[url('/bg-boost-mobile.svg')] bg-cover bg-no-repeat py-[5.625rem] lg:gap-y-8 lg:bg-[url('/bg-boost-desktop.svg')] lg:py-[57px]"}
    >
